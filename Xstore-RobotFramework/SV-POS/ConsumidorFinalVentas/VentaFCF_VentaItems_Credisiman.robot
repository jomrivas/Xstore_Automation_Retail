...
*** Test Cases ***
Flujo de venta CF con items precio regular y forma de pago Credisiman
    [Documentation]    Flujo de venta con documento CF, items a precio regular y forma de pago Credisiman.
