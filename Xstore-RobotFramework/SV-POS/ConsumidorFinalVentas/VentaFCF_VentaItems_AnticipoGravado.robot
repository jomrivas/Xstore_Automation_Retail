...
*** Test Cases ***
Flujo de venta CF con items precio regular y forma de pago Anticipo gravado
    [Documentation]    Flujo de venta con documento CF, items a precio regular y forma de pago Anticipo gravado.
