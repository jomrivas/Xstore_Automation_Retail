*** Settings ***
Documentation     Venta CF con items precio regular con descuentos y forma de pago cheque - Descuentos al item y a la trx
...
*** Test Cases ***
Flujo de venta CF con items precio regular con descuento manual forma de pago Cheque
    [Documentation]    Flujo de venta con documento CF, items a precio regular con descuentos al items y a la trx, forma de pago cheque
