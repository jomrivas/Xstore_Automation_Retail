*** Settings ***
Documentation     Script de venta con forma de pago Cheque.
...
${ITEM_2}                       NONE
${ITEM_3}                       NONE
${MONTO_IVA_RETENIDO_CHEQUE}    NONE


*** Test Cases ***
Flujo de venta Institucional (renteción de IVA) con items precio regular y forma de pago Cheque
    [Documentation]    Flujo de venta con documento CF Venta Institucional (Rentención de IVA), items a precio regular y forma de pago Cheque.
    ...
    Accion_IngresarDatosTender_MontoVenta
...
Inicializar Entorno
    ...
    Set Suite Variable    ${MONTO_IVA_RETENIDO_CHEQUE}    ${env["MONTO_IVA_RETENIDO_CHEQUE"]}
...
Accion_SeleccionarFormaDePago
    # Selecciona boton "Forma de pago"
    Send And Wait    {F10}
...
Accion_IngresarDatosTender_MontoVenta
    ...
    Send And Wait    ${MONTO_IVA_RETENIDO_CHEQUE}
    Send And Wait    {ENTER}
    Sleep    0.5s
    Send And Wait    {ENTER}
