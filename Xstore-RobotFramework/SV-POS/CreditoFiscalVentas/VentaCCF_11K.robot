...
*** Test Cases ***
Flujo de venta CCF con items precio regular y forma de pago efectivo - Monto mayor a 11k
    [Documentation]    Flujo de venta con documento CCF, items a precio regular y forma de pago efectivo, monto de venta mayor a 11k.
