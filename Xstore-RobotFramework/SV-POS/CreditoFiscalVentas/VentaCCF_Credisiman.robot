...
${CREDISIMAN}           NONE
${MONTO_CREDISIMAN}     NONE


*** Test Cases ***
Flujo de venta CCF con items precio regular y forma de pago Credisiman
    [Documentation]    Flujo de venta con documento CCF, items a precio regular y forma de pago Credisiman.
    ...
    Accion_SeleccionarFormaDePago_Credisiman
...
Inicializar Entorno
    ...
    Set Suite Variable    ${MONTO_CREDISIMAN}     ${env["MONTO_CREDISIMAN"]}
...
Accion_IngresarSerie_MontoVenta
    ...
    Send And Wait    {ENTER} 
    Send And Wait    ${MONTO_CREDISIMAN}
    Send And Wait    {ENTER}
    Sleep    0.5s
    Send And Wait    {ENTER}
