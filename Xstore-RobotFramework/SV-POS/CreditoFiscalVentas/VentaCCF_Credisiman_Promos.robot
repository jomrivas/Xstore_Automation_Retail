...
*** Test Cases ***
Flujo de venta CCF con items com promos y forma de pago Credisiman
    [Documentation]    Flujo de venta con documento CCF, items com promos RPM, ORCE, Liquidación y forma de pago Credisiman.
...
Accion_IngresarSerie_MontoVenta
    # ingreso de número de tarjeta y monto a pagar
    Send And Wait    ${CREDISIMAN_PROMOS}
    Send And Wait    {ENTER} 
    Send And Wait    ${MONTO_PROMOS}
    Send And Wait    {ENTER}
    Sleep    0.5s
    #Send And Wait    {ENTER}
