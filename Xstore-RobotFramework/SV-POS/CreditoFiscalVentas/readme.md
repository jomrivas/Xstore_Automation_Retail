...
**Automatización con Robot Framework – Comprobante de Crédito Fiscal (CCF) – El Salvador**

## Descripción del Proyecto

Este proyecto contiene un conjunto de pruebas automatizadas desarrolladas con **Robot Framework** para validar flujos de venta en **Xstore POS**, incluyendo la generación, registro y validación del **Comprobante de Crédito Fiscal (CCF)** conforme a los requerimientos fiscales de **El Salvador**.
...
*   Validación de datos fiscales específicos del CCF (NRC, NIT, etc.)
...
## Estructura del Proyecto
    ...
    requirement.txt
    VentaCCF_11K.robot
    VentaCFF_AnticipoGravado.robot
    VentaCCF_CeretificadoRefalo.robot
    VentaCCF_Credisiman_Promos.robot
    VentaCCF_Credisiman.robot
    VentaCCF_Descuentos_Items_Trx.robot
    VentaCCF_TarjetaExterna.robot
    README.md
...
*   Acceso a:
    ...
    *   Datos de Clientes válidos para CCF en El Salvador
