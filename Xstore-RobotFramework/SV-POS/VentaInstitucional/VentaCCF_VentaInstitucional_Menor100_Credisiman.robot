...
${CREDISIMAN}           NONE
${MONTO_VENTA_INST}     NONE


*** Test Cases ***
Flujo de venta Institucional con items precio regular y forma de pago Credisiman
    [Documentation]    Flujo de venta con documento CF Venta Institucional, items a precio regular y forma de pago Credisiman.
...
Inicializar Entorno
    ...
    Set Suite Variable    ${ITEM_4}               ${env["ITEM_4"]}
    Set Suite Variable    ${CREDISIMAN}           ${env["CREDISIMAN"]}
    Set Suite Variable    ${MONTO_VENTA_INST}     ${env["MONTO_VENTA_INST"]}
...
Accion_IngresarSerie_MontoVenta
    Send And Wait    ${CREDISIMAN}
    Send And Wait    {ENTER} 
    Send And Wait    ${MONTO_VENTA_INST}
    Send And Wait    {ENTER}
    Sleep    0.5s
    Send And Wait    {ENTER}
