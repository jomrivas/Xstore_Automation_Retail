...
*** Test Cases ***
Venta Items con Promos, forma de Pago Tarjeta Devolucion serie 75
    [Documentation]    Flujo de venta items precio regular con forma de pago Tarjeta Devolucion serie 75.
    ...
    # Seleccionar Medio de Pago: Tarjeta Devolucion
    Wait Until Element Is Visible    xpath=//*[@text="TARJETA DE DEVOLUCION"]  2s
    Click Element    xpath=//*[@text="TARJETA DE DEVOLUCION"]
    Sleep    1s

    # Ingresar Tarjeta (Keyword de Utilidad)
    Ingresar Tarjeta En Teclado Visual    ${TARJETAS}[tarjeta_devolucion]
